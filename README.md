...
- Casual Riders:
	...
	- Prefer scenic and tourist-heavy locations. Indicates a focus on leisure and sightseeing.
- Annual Members:
...
### Credits
Some EDA techniques adapted from: 
- https://github.com/GaneshHonrao/Google-Data-Analytics-Capstone-Project-on-Cyclistic-Bike-Share-With-SQL-Tableau.git
- https://github.com/SomiaNasir/Google-Data-Analytics-Capstone-Cyclistic-Case-Study.git
